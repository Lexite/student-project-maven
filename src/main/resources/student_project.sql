...
(
    ...
    FOREIGN KEY (h_passport_office_id) REFERENCES jc_university(university_id) ON DELETE RESTRICT,
    ...
    FOREIGN KEY (w_passport_office_id) REFERENCES jc_university(university_id) ON DELETE RESTRICT,
